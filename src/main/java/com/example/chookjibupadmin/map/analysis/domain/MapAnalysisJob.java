...
@Getter
@Table(
        name = "map_analysis_job",
        uniqueConstraints = @UniqueConstraint(
                name = "uk_map_analysis_job_public_id",
...
public class MapAnalysisJob extends BaseTimeEntity {
    ...
    public static MapAnalysisJob pending(
            Long mapId,
            String provider,
            String model,
            String inputImageKey,
            String checksum,
            int width,
            int height
    ) {
    ...
    public void start() {
        if (status != MapAnalysisJobStatus.PENDING) {
            return;
        }
    ...
    public void complete(
        ...
        if (status != MapAnalysisJobStatus.PROCESSING) {
            return;
        }
    ...
    public void fail(String code, String message) {
        if (status == MapAnalysisJobStatus.CANCELLED) {
            return;
        }
