...
public enum SuccessCode {
    ...
    FESTIVAL_MAP_CREATE_SUCCESS(22021, "축제 좌표 지도가 준비되었습니다."),
    ...
    FESTIVAL_REVIEW_QR_READ_SUCCESS(22027, "축제 리뷰 QR 조회가 완료되었습니다."),
    ...
    FESTIVAL_CONGESTION_READ_SUCCESS(23012, "축제 혼잡도 조회가 완료되었습니다."),
    FESTIVAL_QUEUE_READ_SUCCESS(23013, "축제 대기열 조회가 완료되었습니다."),
    FESTIVAL_QUEUE_UPDATE_SUCCESS(23014, "축제 대기열 줄끝 정보가 수정되었습니다."),
    FESTIVAL_OPERATION_SUGGESTION_READ_SUCCESS(23015, "축제 운영 제안 조회가 완료되었습니다."),
    FESTIVAL_OPERATIONS_MAP_READ_SUCCESS(23016, "현장 운영 지도 조회가 완료되었습니다."),
