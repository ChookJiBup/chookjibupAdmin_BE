...
VALUES
    (910031, 'b0000031-0000-4000-8000-000000000031', 'GOVERNMENT', 'admin01@seed.mapo.go.kr', '연결테스트01', '관광정책과', '과장', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910032, 'b0000032-0000-4000-8000-000000000032', 'GOVERNMENT', 'admin02@seed.mapo.go.kr', '연결테스트02', '관광정책과', '주무관', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910033, 'b0000033-0000-4000-8000-000000000033', 'CONTRACTOR', 'admin03@seed-event.co.kr', '연결테스트03', '이벤트업체A', NULL, '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910034, 'b0000034-0000-4000-8000-000000000034', 'GOVERNMENT', 'admin11@seed.mapo.go.kr', '미연결11', '문화관광과', '과장', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910035, 'b0000035-0000-4000-8000-000000000035', 'GOVERNMENT', 'admin12@seed.mapo.go.kr', '미연결12', '문화관광과', '주무관', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910036, 'b0000036-0000-4000-8000-000000000036', 'CONTRACTOR', 'admin13@seed-event.co.kr', '미연결13', '이벤트업체B', NULL, '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910037, 'b0000037-0000-4000-8000-000000000037', 'GOVERNMENT', 'admin21@seed.mapo.go.kr', '세트C01', '축제추진단', '과장', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910038, 'b0000038-0000-4000-8000-000000000038', 'GOVERNMENT', 'admin22@seed.mapo.go.kr', '세트C02', '축제추진단', '주무관', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910039, 'b0000039-0000-4000-8000-000000000039', 'CONTRACTOR', 'admin23@seed-event.co.kr', '세트C03', '이벤트업체C', NULL, '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910040, 'b0000040-0000-4000-8000-000000000040', 'GOVERNMENT', 'admin31@seed.mapo.go.kr', '세트D01', '도시디자인과', '과장', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910041, 'b0000041-0000-4000-8000-000000000041', 'GOVERNMENT', 'admin32@seed.mapo.go.kr', '세트D02', '도시디자인과', '대리', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910042, 'b0000042-0000-4000-8000-000000000042', 'CONTRACTOR', 'admin33@seed-event.co.kr', '세트D03', '이벤트업체D', NULL, '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910043, 'b0000043-0000-4000-8000-000000000043', 'GOVERNMENT', 'admin41@seed.mapo.go.kr', '세트E01', '안전총괄과', '과장', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910044, 'b0000044-0000-4000-8000-000000000044', 'GOVERNMENT', 'admin42@seed.mapo.go.kr', '세트E02', '안전총괄과', '주무관', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910045, 'b0000045-0000-4000-8000-000000000045', 'CONTRACTOR', 'admin43@seed-event.co.kr', '세트E03', '이벤트업체E', NULL, '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910046, 'b0000046-0000-4000-8000-000000000046', 'GOVERNMENT', 'admin51@seed.mapo.go.kr', '세트F01', '관광정책과', '과장', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910047, 'b0000047-0000-4000-8000-000000000047', 'GOVERNMENT', 'admin52@seed.mapo.go.kr', '세트F02', '관광정책과', '대리', '__BCRYPT__', 0, 'ACTIVE', now(), now()),
    (910048, 'b0000048-0000-4000-8000-000000000048', 'CONTRACTOR', 'admin53@seed-event.co.kr', '세트F03', '이벤트업체F', NULL, '__BCRYPT__', 0, 'ACTIVE', now(), now());
